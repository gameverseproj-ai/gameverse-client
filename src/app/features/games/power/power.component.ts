...
@Component({ selector: 'app-power', standalone: true, imports: [RouterLink, PowerSceneComponent, PowerTrainingComponent], templateUrl: './power.component.html', styleUrl: './power.component.scss' })
